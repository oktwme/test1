...
public:
	static void Custom()
	{
		...
		ImGui::Text("Body:");
		ImGui::InputTextMultiline("##inputBody", (requestText), IM_ARRAYSIZE(requestText), ImVec2(S.Window.width - 130.f, (label_size.y + ImGui::GetStyle().FramePadding.y) * 6.f), ImGuiInputTextFlags_AllowTabInput);
		...
		if (ImGui::CollapsingHeader("Custom Port/Header"))
		{
			...
			ImGui::Text("Header:");
			ImGui::InputTextMultiline("##inputHeader", (inputHeader), IM_ARRAYSIZE(inputHeader), ImVec2(S.Window.width - 130.f, (label_size.y + ImGui::GetStyle().FramePadding.y) * 6.f), ImGuiInputTextFlags_AllowTabInput);
		...
		if (!sResultJson.empty())
		{
			...
			ImGui::InputTextMultiline("##customResult", cResultJson, sResultJson.size() + 1, ImVec2(S.Window.width - 130.f, (label_size.y + ImGui::GetStyle().FramePadding.y) * 19.f));
		}
	}

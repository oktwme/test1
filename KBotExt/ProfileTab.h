...
public:
	static void Render()
	{
		if (ImGui::BeginTabItem("Profile"))
		{
			...
			ImGui::InputTextMultiline("##inputStatus", (statusText), IM_ARRAYSIZE(statusText), ImVec2(S.Window.width - 230.f, (label_size.y + ImGui::GetStyle().FramePadding.y) * 6.f), ImGuiInputTextFlags_AllowTabInput);

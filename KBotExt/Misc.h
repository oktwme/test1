...
public:
	...
	static inline std::string programVersion = "1.4.3";
	...
	{
		std::string getLatest = cpr::Get(cpr::Url{ "https://api.github.com/repos/BennyExtreme/KBotExt/releases/latest" }).text;
